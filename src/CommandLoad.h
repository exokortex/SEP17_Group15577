...
#ifndef COMMAND_LOAD_H_INCLUDED
#define COMMAND_LOAD_H_INCLUDED
...
class CommandLoad : public Command
{
  private:
    ...
    //
    CommandLoad(const CommandLoad& original) = delete;

    //--------------------------------------------------------------------------
    // Private assignment operator
    //
    CommandLoad& operator=(const CommandLoad& original) = delete;
